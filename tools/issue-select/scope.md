...
- Repo: `codepath/pathreview-ai301-fa26-s3`
 <!-- paste your section's repo from the Unit 1 Check-In page -->
...
I come from a finance background, with experience in data analysis but not in
production software or hands-on engineering. I'm comfortable with Python, HTML,
and CSS. Through this course, I want to gain real-world software engineering
experience — understanding how the frontend, backend, business logic, and
database layers actually connect and work together — with the goal of eventually
growing into a junior-level SWE role. I'd like to avoid very large or complex
codebases, languages I don't know at all, and issues that assume deep familiarity
with how these layers interact, since that's exactly what I'm still learning.
